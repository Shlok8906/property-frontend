...
const NotFound = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#030712] overflow-hidden p-6">
      ...
      <div className="absolute w-[500px] h-[500px] border border-white/5 rounded-full animate-ping opacity-20" />
      <div className="absolute w-[300px] h-[300px] border border-white/10 rounded-full animate-pulse opacity-20" />
      ...
      <div className="relative z-10 max-w-2xl text-center space-y-8">
        ...
        <div className="relative inline-block">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-tight animate-bounce">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full sm:w-auto h-14 px-8 rounded-2xl border-white/10 bg-white/5 text-white hover:bg-white/10 transition-all"
          >
            <Link to="/properties">
        ...
        {/* Breadcrumb Context */}
        <div className="pt-12 text-[10px] uppercase font-black tracking-[0.3em] text-gray-600 flex items-center justify-center gap-3">
